...
/**
 * 设置模块：安装 / 配置 / 工作区 + 检查更新 / 关于。
 */
public class SettingsFragment extends Fragment {

    private static final TabOption[] TAB_OPTIONS = {
            new TabOption("安装", "分步安装 rootfs / 工具 / Node / harness", "↓", R.drawable.bg_icon, InstallFragment::new),
            new TabOption("配置", "API key · 端口 · 模型 · 沙箱模式", "⚙", R.drawable.bg_icon_warn, ConfigFragment::new),
            new TabOption("工作区", "工作目录 · 文件共享 · 备份恢复 · Shizuku", "📁", R.drawable.bg_icon_ok, WorkspaceFragment::new),
    };
    ...
    private static final class TabOption {
        ...
        TabOption(String title, String sub, String icon, int iconBg, Supplier<Fragment> factory) {
            this.title = title;
            this.sub = sub;
            this.icon = icon;
            this.iconBg = iconBg;
