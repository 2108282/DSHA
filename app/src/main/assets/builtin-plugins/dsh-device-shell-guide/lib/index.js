...
const PROMPT = [
  ...
  '  2) Android 框架接口：走 127.0.0.1:3095/app/*（零配置免 ADB/Shizuku：无障碍读屏点按、通知栏、剪贴板、传感器等）。',
  '  3) 宿主 Shell 通道：走 127.0.0.1:3095/exec?cmd=<urlencoded>（查询系统日志 logcat、pm、am、dumpsys、进程查看）。',
